        ...
        <CardContent className="p-4">
          <div className="border-b pb-4">
            <h2 className="text-lg font-bold mb-0">
              {data.workExperiences[0].title}
            </h2>
            <div className="text-sm">
              <div id="company-name">
                <a
                  href={data.workExperiences[0].company.url}
                  className="flex items-center gap-1 dark:text-orange-500 dark:hover:text-orange-500"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {data.workExperiences[0].company.name}{" "}
              ...
              <div className="flex gap-5 text-muted-foreground mt-2">
                <div id="location" className="flex items-center gap-1">
                  ...
                  {data.workExperiences[0].location}
                </div>
                <div id="date-range">{data.workExperiences[0].dateRange}</div>
              </div>
              <div className="mt-4">
